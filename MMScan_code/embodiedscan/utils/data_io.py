...
class id_mapping:
    def __init__(self,
                mp3d_mapping_path = '/mnt/petrelfs/linjingli/mmscan_modelzoo-main/embodiedscan_infos/mp3d_mapping.json',
                trscan_mapping_path = '/mnt/petrelfs/linjingli/mmscan_modelzoo-main/embodiedscan_infos/3rscan_mapping.json'
                ):
        ...
        with open(trscan_mapping_path,'r') as f:
            self.trscan_mapping = json.load(f)

        self.mp3d_mapping_trans = reverse_dict(self.mp3d_mapping)
        self.trscan_mapping_trans = reverse_dict(self.trscan_mapping)
