...
def clean_answer(data, model= 'leo'):
...
def QA_prompt_define():
    ...
    system_prompt = 'Evaluate a model-generated QA result against a human-generated answer for a 3D model. I will give you a dict with "Question", "Model Answer" and "".Please fully understand the meaning of both s and  follow these three steps to evaluate the model-generated answer: First step, identify all key points in the human answer and list them; Scecond step, compare each of these key points in the model-generated answer, count the number of key points which are correct in the model-generated answer, also, count the number of key points which are missing or error in the model-generated answer. Provide reasons for each evaluation, you should not be too strict, as long as a key point has no significant difference in model and human, regard it as correct one; Third step, output the "All key points" (list), "Correct Number" (int), "Wrong/Missing Number"(int), "Reasons" (str) in a JSON format.( Obviously the "Correct Number"+"Wrong/Missing Number" should be equal to the total number of key points). Give you some examples, '
    ex_instance = 'The input is: { "Question" : "What is the function of this object?", "Model Answer" : "It can hang clothes for storage.", "Human Answer" : "Providing storage space." }, the expected output is { "All key points" : ["function of the object: providing storage space"], "Correct Number" : 1, "Wrong/Missing Number" : 0, "Reasons" : "A place for hanging clothes also provides storage space." }; '
    ex_instance += 'The input is: { "Question" : "What is the placement of this object?", "Model Answer" : "It is placed vertically on the table", "Human Answer" : "It placement is standing upright on the floor. " }, the expected output is { "All key points" : ["placement of the object: standing upright","surface the object is standing upright on: on the floor"], "Correct Number" : 1, "Wrong/Missing Number" : 1, "Reasons" : "The model correctly identifies the object is standing but fails to identify the surface it is standing on." }; '
    ex_instance += 'The input is { "Question" : "Please compare these two objects closely, are they similar in material? Given me the answer and reason.", "Model Answer" : "No, because the object is made of plastic and the pillow is made of cotton.", "Human Answer" : "No,  because the bowl is wooden and the pillow is soft fabric."}, the expected output is { "All key points" : ["Yes or No : No","Texture of the bowl : wooden ","Texture of the pillow : soft fabric"], "Correct Number" : 2, "Wrong/Missing Number" : 1, "Reasons" : "The model correctly identifies the material of pillow (cotton is soft fabric) but fails to recognize the material of the bowl." }. '
