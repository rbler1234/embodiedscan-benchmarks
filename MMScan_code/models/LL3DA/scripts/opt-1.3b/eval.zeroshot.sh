...
python main.py \
    ...
    --captioner ll3da \
    --test_ckpt /mnt/petrelfs/linjingli/mmscan_modelzoo-main/llmzoo/LL3DA/pretrained/ll-gernalist/ll3da-opt-1.3b.pth  \
    --dataset unified_embodied_scan_qa \
    --vocab facebook/opt-1.3b \
    --qformer_vocab bert-base-embedding \
    --checkpoint_dir ckpts/opt-1.3b/test_zeroshot \
    --dist_url tcp://localhost:12345 \
    --criterion 'CiDEr' \
    --freeze_detector --freeze_llm \
    --batchsize_per_gpu 12 --ngpus 2 \
    --max_des_len 512 \
    --max_prompt 1 \
    --use_beam_search \
    --test_only
